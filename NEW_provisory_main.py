...
def main():
    ...
    path_p31 = os.path.join(base_dir, "csv", "p31")
    os.makedirs(path_p31, exist_ok=True)
    ...
    x_initial_bck_df.to_csv(os.path.join(path_p52, "x_initial_nm_bck.csv"), sep=',')
    x_initial_tr_bck_df.to_csv(os.path.join(path_p52, "x_initial_tr_bck.csv"), sep=',')
    x_random_bck_df.to_csv(os.path.join(path_p52, "x_random_nm_bck.csv"), sep=',')
    x_random_tr_bck_df.to_csv(os.path.join(path_p52, "x_random_tr_bck.csv"), sep=',')
